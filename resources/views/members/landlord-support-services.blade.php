...
<div class="alert alert-info mb-4">
    ...
    <section class="mb-5">
        <h2 class="h3 mb-4 text-primary">All-in-One Property Management Platforms</h2>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <div class="badge bg-success mb-1">Revenue generation through tenant services</div>
                            <div class="badge bg-info mb-1">CPD-accredited training</div>
                        </div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="badge bg-success mb-2">No need for additional accounting software like Xero</div>
                        <p class="mt-2 mb-1"><strong>Best For:</strong> Serious investors wanting all-in-one solution</p>
                        <p class="text-success small mb-0"><strong>Pricing:</strong> 14-day free trial available</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="badge bg-warning text-dark mb-2">MTD-ready for Making Tax Digital compliance</div>
                        <p class="mt-2 mb-1"><strong>Best For:</strong> Small to medium landlords</p>
                        <p class="text-success small mb-0"><strong>Pricing:</strong> 30-day free trial, free version for up to 3 properties</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="badge bg-primary mb-2">Highly scalable with custom processes</div>
    ...
    <section class="mb-5">
        <h2 class="h3 mb-4 text-primary">Specialist Services</h2>
    ...
    <section class="mb-5">
        <h2 class="h3 mb-4 text-primary">Tenant Services & Protection</h2>
            ...
            <div class="col-lg-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge bg-info">Comprehensive tenant vetting</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge bg-info">Reducing tenant barriers</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge bg-info">Cash flow friendly</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mb-5">
        <h2 class="h3 mb-4 text-primary">Key Considerations When Choosing</h2>
                ...
                <div class="card border-warning">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-success py-2 mb-0">
                            <strong>MTD-Ready:</strong> Landlord Studio confirmed compliant
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                ...
                                <span class="small text-success">Free versions (Landlord Studio, PropertyJinni)</span>
                            </li>
                            <li class="mb-2">
