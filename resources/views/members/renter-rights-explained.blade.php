...
@section('title', 'Renter Rights Explained')

@section('content')
<h1 class="mb-4">What May 1st Actually Means For You</h1>

<p>The Renters Rights Act became law in October 2025. From 1 May 2026 it takes full effect. Here is what that means in practice — not in legal language, but in terms of your daily life as a renter.</p>
...
<h3 class="mb-3">Your tenancy no longer has an end date</h3>
...
<h3 class="mb-3">Rent increases are limited</h3>

<p>Your landlord can only raise your rent once a year, and any increase must reflect actual market rates. If you think the increase is above market, you can challenge it at the First-tier Tribunal. This is a real right, not a theoretical one.</p>

<hr>

<h3 class="mb-3">No more bidding wars</h3>

<p>Landlords and agents can no longer accept offers above the advertised price. The practice of quietly encouraging tenants to outbid each other is now illegal. The advertised price is the price.</p>
...
<h3 class="mb-3">You can have a pet</h3>

<p>Landlords cannot unreasonably refuse a request to keep a pet. The blanket "no pets" clause that appears in most tenancy agreements is no longer enforceable as a matter of course.</p>
