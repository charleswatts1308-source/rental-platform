...
<head>
    <meta charset="utf-8">
    <title>Your repair case is ready for the next step</title>
</head>
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border:1px solid #e0e4e8;border-radius:6px;padding:32px;">
                    <tr>
                        <td>
                            <h1 style="margin:0 0 16px 0;font-size:20px;color:#0f172a;">Time to choose the next step</h1>
                            <p style="margin:0 0 16px 0;line-height:1.5;">
                                We didn't hear back on your case <strong>{{ $case->url_slug }}</strong> within the expected window.
                            </p>
                            <p style="margin:0 0 24px 0;line-height:1.5;">
                                Sign in to send the next letter, pause the case, mark it resolved, or step away.
                            </p>
