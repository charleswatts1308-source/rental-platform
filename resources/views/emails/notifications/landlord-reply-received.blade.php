...
<head>
    <meta charset="utf-8">
    <title>Your repair case has a new reply</title>
</head>
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border:1px solid #e0e4e8;border-radius:6px;padding:32px;">
                    <tr>
                        <td>
                            <h1 style="margin:0 0 16px 0;font-size:20px;color:#0f172a;">A new reply on your repair case</h1>
                            <p style="margin:0 0 16px 0;line-height:1.5;">
                                We've received a reply for case <strong>{{ $case->url_slug }}</strong>.
                            </p>
                            <p style="margin:0 0 24px 0;line-height:1.5;">
                                For privacy, the message itself is only visible inside your dashboard.
                                Sign in to read it and decide what to do next.
                            </p>
