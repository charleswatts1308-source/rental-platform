    ...
    <form method="POST" action="{{ route('rentals.store') }}" enctype="multipart/form-data">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-header bg-primary text-white">
                <h2 class="h5 mb-0">New Rental Property</h2>
                <small class="opacity-75">Create a new rental property profile</small>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="bg-light rounded p-3 h-100">
                            ...
                            <div class="mb-3">
                                <label for="rental_agreement" class="form-label">Upload Document (PDF, Images, Word, Excel)</label>
                                <input type="file" class="form-control" id="rental_agreement" name="rental_agreement"
                                       accept=".pdf,.jpg,.jpeg,.png,.doc,.docx,.xls,.xlsx">
                                <small class="form-text text-muted">Maximum file size: 2MB. File will be uploaded when you create the rental.</small>
                            </div>
                        </div>
                    </div>
